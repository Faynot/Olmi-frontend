  ...
  return (
    <div className="relative h-screen w-full flex items-center justify-center bg-white px-4">
      ...
      <button
        ...
        className="absolute bottom-30 lg:bottom-20 transition-transform hover:scale-110 cursor-pointer active:scale-90 bg-[#FBF4EA] flex items-center justify-center w-20 h-20 lg:w-[115px] lg:h-[115px] rounded-full"
